...
class Biblioteca:
    ...
    def emprestar_livro(self):
        ...
        if usuario_encontrado and livro_encontrado: #verifique o encontro do livro e usuario
            ...
            dados_emprestimo = (nome_usuario, livro_emprestado) # armazena os dados que entrarão na lista
            ...
            print(f'O livro {livro_emprestado} foi emprestado para {nome_usuario} com sucesso!\n')
